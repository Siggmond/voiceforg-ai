...
![Stars](https://img.shields.io/github/stars/Siggmond/voiceforge-ai?style=flat)
![Last Commit](https://img.shields.io/github/last-commit/Siggmond/voiceforge-ai?style=flat)
...
All screenshots below are taken from a live local run of the backend and Swagger UI.

### 01-swagger-home.png
FastAPI Swagger UI showing the documented API surface.

![Swagger Home](docs/screenshots/01-swagger-home.png)

### 02-openapi-endpoints-list.png
List of available REST and WebSocket endpoints.

![OpenAPI Endpoints](docs/screenshots/02-openapi-endpoints-list.png)

### 03-analyze-request.png
Text-only analysis request using the `/analyze` endpoint.

![Analyze Request](docs/screenshots/03-analyze-request.png)

### 04-analyze-response.png
Structured intelligence JSON returned by the LLM.

![Analyze Response](docs/screenshots/04-analyze-response.png)

### 05-transcribe-upload-form.png
Audio file upload form for speech transcription.

![Transcribe Upload](docs/screenshots/05-transcribe-upload-form.png)

### 06-transcribe-response.png
End-to-end transcription and intelligence output.

![Transcribe Response](docs/screenshots/06-transcribe-response.png)

### 07-terminal-startup-logs.png
Backend startup logs showing decoder configuration and readiness.

![Startup Logs](docs/screenshots/07-terminal-startup-logs.png)
